...
function createOptionsScreen() {
    ...
    createBt(ResumeBt, "Reprendre", false);
    ...
    createBt(RestartBt, "Recommencer", false);
    ...
    createBt(ExitBt, "Menu principal", "MainMenu");
    ...
    createBt(InstructionsBt, "Comment jouer", "Instructions");
...
function createWinText() {
    ...
    createBt(ContinueBt, "Formidable ! Continuer", "Finish");
    ...
    createBt(AgainBt, "Recommencer", false);
...
function createInputKeys() {
    ...
    M_Key = Climb.game.input.keyboard.addKey(Phaser.Keyboard.S);
...
function createTimer() {
    ...
    best = Climb.game.add.text(17, 58, "MEILLEUR : " + bestTime, copyright_style);
    best.anchor.set(0, 0.5);
    // best.visible = false;
    userinterface.add(best);

    if (bestTime == null) {
        best.text = "MEILLEUR : 0.0";
    }
}
